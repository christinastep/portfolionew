    ...
    window.onscroll = function () {
      if (document.documentElement.scrollTop > window.innerHeight) {
        ...
        if (document.documentElement.scrollTop > window.innerHeight * 1.15) {
          ...
          for (var i = 0; i < headlineElementsAbout.length; i++) {
          ...
          if (document.documentElement.scrollTop > window.innerHeight * 1.25) {
            ...
            if (document.documentElement.scrollTop > window.innerHeight * 2.4) {
              ...
              for (var _i = 0; _i < headlineElementsProjects.length; _i++) {
                headlineElementsProjects[_i].classList.add('animationActive');
              }
            }
          }
        }
        ...
        for (var _i2 = 0; _i2 < headlineElements.length; _i2++) {
          headlineElements[_i2].classList.remove('animationActive');
        }
...
if (window.matchMedia('(min-width: 640px)').matches) {
  var _loop = function _loop(i) {
    projectBox[i].addEventListener('click', function () {
      ...
      for (var _i3 = 0; _i3 < projectBox.length; _i3++) {
        projectBox[_i3].style.backgroundColor = 'black';
      }
    ...
    projectFull[i].addEventListener('click', function () {
      ...
      for (var _i4 = 0; _i4 < projectBox.length; _i4++) {
        projectBox[_i4].style.backgroundColor = 'white';
      }
    });
  };
